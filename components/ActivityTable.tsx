                ...
                <table className="w-full border-collapse border border-slate-300 text-sm">
                    <thead className="bg-slate-50 text-slate-600 font-bold text-xs uppercase text-center">
                        <tr>
                            ...
                            <th className="border border-slate-300 p-2 w-48">Chủ đề</th>
                            ...
                            <th className="border border-slate-300 p-2 w-24">Địa điểm</th>
                            <th className="border border-slate-300 p-2 w-20">Chủ trì</th>
                            <th className="border border-slate-300 p-2 w-20">Phối hợp</th>
                            <th className="border border-slate-300 p-2 w-24">Điều kiện</th>
                        </tr>
                            ...
                            return (
                                <tr key={lesson.id} className="hover:bg-slate-50 transition-colors">
                                    ...
                                    <td className="border border-slate-300 p-2 font-medium text-slate-800">
                                        <textarea 
                                            className="w-full bg-transparent outline-none focus:underline resize-none h-full min-h-[40px] text-xs"
                                            rows={2}
                                            value={lesson.title}
                                    ...
                                    <td className="border border-slate-300 p-2 text-center bg-slate-50/50">
                                        <div className="flex items-center gap-1 justify-center text-[10px] text-slate-500 font-bold whitespace-nowrap">
                                            <Calendar size={10}/> {lessonTimings[lesson.id] || "..."}
                                        </div>
                                    </td>
                                    ...
                                    <td className="border border-slate-300 p-2">
                                        <div className="flex items-center gap-1">
                                            <UserCog size={12} className="text-slate-400 shrink-0"/>
                                            <input 
                                                className="w-full text-xs bg-transparent outline-none placeholder-slate-300"
                                                placeholder="GV Tin"
                                                value={lesson.host || ''}
